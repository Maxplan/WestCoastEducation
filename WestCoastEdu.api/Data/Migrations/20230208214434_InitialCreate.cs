    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompetenceTeacher", x => new { x.CompetencesId, x.TeachersId });
                    table.ForeignKey(
                        name: "FK_CompetenceTeacher_Competences_CompetencesId",
                        column: x => x.CompetencesId,
                        principalTable: "Competences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompetenceTeacher_Teachers_TeachersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationWk = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetenceTeacher_TeachersId",
                table: "CompetenceTeacher",
                column: "TeachersId");
